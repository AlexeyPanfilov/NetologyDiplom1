В данном проекте необходимо было реализовать интерфейсы конвертера и цветовой схемы. То есть написать логику преобразования изображения в текстовую графику по представленным в задании исходным данным.
